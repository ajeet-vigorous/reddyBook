          ...
          <div className="w-full py-4">
            <div className="">
              <div className="md:flex items-center lg:gap-6 gap-4 mb-3">
                <label
                  htmlFor="oldPassword"
                  className="w-40 whitespace-nowrap text-right text-black font-normal text-xs"
                >
                  Current Password :
                </label>
                <div className="w-full relative">
                  <input
                    ...
                    className={`w-full py-1.5 px-3 text-[14px] rounded border ${
                  ...
                  />
                  {errorslogin?.oldPassword && (
                    <span className="absolute right-2 top-2 text-red-500 text-lg">
                      <CiCircleInfo className="rotate-180" />
                    </span>
                  )}
              ...
              <div className="italic text-xs mt-4 space-y-1">
                ...
                <p>
                  <span className="font-semibold">Note: </span>
                  The New Password must contain at least: 1 uppercase letter, 1
