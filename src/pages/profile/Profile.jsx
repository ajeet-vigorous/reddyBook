                ...
                <div className='lg:flex justify-between items-start lg:space-x-5 w-full mt-2'>
                    ...
                    <div className='lg:w-[65%] w-full border rounded-md shadow-xl px-3 bg-white  border-gray-100'>
                        <div className='flex border-b border-gray-200 w-full justify-center items-center text-center'>
                            ...
                            <button
                                className={`px-4 py-2 sm:text-sm text-xs font-medium uppercase w-full whitespace-nowrap tracking-wide ${activeTab === 'stacksettings' ? 'text-black border-b-2 border-[var(--secondary)]' : 'text-black hover:text-[var(--secondary)]'}`}
                                onClick={() => handleTabChange('stacksettings')}
                            >
                                stack settings
                            </button>
                            <button
                                className={`px-4 py-2 sm:text-sm text-xs font-medium uppercase w-full whitespace-nowrap tracking-wide ${activeTab === 'changepassword' ? 'text-black border-b-2 border-[var(--secondary)]' : 'text-black hover:text-[var(--secondary)]'}`}
