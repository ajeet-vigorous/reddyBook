...
const handleSelectCode = (code) => {
  ...
  const handleOnSubmit = async (e) => {
    ...
    if (!user.password || user.password.length < 6) {
      setErrors({ ...errors, password: "Password must be at least 6 characters long and in format Ab1234" });
      return;
    }
    ...
    try {
      ...
      message.error(error?.data?.message || "An error occurred during registration.");
    } finally {
      setLoading(false);
    }
  };
